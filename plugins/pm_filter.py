...
async def pm_text(bot, message):
    ...
    await message.reply_text("<b>Sorry, But we not fulfill your Request here. Join our @movieverse_discussion_2 group and drop your request there and get your favorite movie.</b>")
    ...
    if query.data.startswith("file"):
                    ...
                    if IS_VERIFY and not await check_verification(client, query.from_user.id):
                        ...
                        await client.send_cached_media(
                            ...
                            reply_markup=InlineKeyboardMarkup(
                                ...
                                InlineKeyboardButton("Bᴏᴛ Oᴡɴᴇʀ", url="t.me/icecube9680_bot")
                                ]
                                ]
                            )
                        )
        ...
        await query.message.edit_text(
            ...
            btn = [[
                    ...
                    InlineKeyboardButton("Cᴏɴᴛᴀᴄᴛ", url="t.me/icecube9680_bot")
                  ]]
            await client.edit_message_media(
                query.message.chat.id, 
                query.message.id, 
