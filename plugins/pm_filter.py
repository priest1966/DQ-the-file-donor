...
async def pm_text(bot, message):
    ...
    await message.reply_text("<b>Sorry, But we not fulfill your Request here. Join our @movieverse_discussion group and drop your request there and get your favorite movie.</b>")
